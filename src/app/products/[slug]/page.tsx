...
Color/Variant: ${product.colorLabel}

Could you please provide more details or a quote?`;

  // Encode the message so it's safe for a URL
  const whatsappUrl = `https://wa.me/919446903829?text=${encodeURIComponent(whatsappMessage)}`;
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="mb-8 border-b border-neutral-200 pb-8">
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`w-4 h-4 rounded-full shadow-inner ${product.colorHex}`}
                />
            ...
            <div className="mb-10">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {product.features.map((feature, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 text-neutral-600 font-medium"
                  >
                    <svg
                ...
                <table className="w-full text-sm text-left">
                  <tbody className="divide-y divide-neutral-200">
                    <tr className="hover:bg-white transition-colors">
                      <th className="px-6 py-4 font-bold text-neutral-900 w-1/3">
                        Material
                      </th>
                    ...
                    <tr className="hover:bg-white transition-colors">
                      <th className="px-6 py-4 font-bold text-neutral-900">
                        Load Capacity
                      </th>
                      <td className="px-6 py-4 text-neutral-600 font-medium">
